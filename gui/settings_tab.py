...
class SettingsTab(TabBase):
    def __init__(self, notebook, gui_handler):
        ...
        # Your variables
        self.project_directory_label = tk.Label(self, text="Project Directory:")
        self.project_directory_label.pack(pady=5)

        self.current_project_path_label = tk.Label(self, text="Current Project Path:")
    ...
    def load_ui(self):
        ...
        project_directory_button = tk.Button(self, text="Update Project Directory", command=self.browse_and_update_project)
    ...
    def update_project_directory_label(self):
        ...
        self.project_directory_label.config(text=f"Currently set Project Directory: {project_directory}")

    def update_current_project_path_label(self):
        current_project_path = self.gui_handler.config_handler.load_current_project_path()
        self.current_project_path_label.config(text=f"Currently set Current Project Path: {current_project_path}")
